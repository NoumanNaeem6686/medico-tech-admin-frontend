...
import { signUpAdmin } from '@/store/slices/userSlice'
...
const SignUp: React.FC = () => {
  ...
  //@ts-ignore
  const { loading, error, isSuccess } = useSelector((state) => state.admin);
  ...
  const handleInputChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (name === "name") {
      ...
      setPassword(value);
      checkPasswords(value, retypePassword);
    } else if (name === "retypePassword") {
      setRetypePassword(value);
      checkPasswords(password, value);
    }
  };
  const checkPasswords = (pass1: string, pass2: string) => {
    if (pass1 !== pass2) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!passwordError && password && retypePassword) {
      const userData = {
        name,
        email,
        password,
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="mb-5">
                  <input
                    ...
                    className="w-full cursor-pointer rounded-lg border border-[#547587] bg-[#547587] p-4 text-white transition hover:bg-opacity-90"
                  />
                </div>
