...
const TableOne = () => {
  ...
  // console.log(
  //   "🚀 ~ TableOne ~ customerHistory, loading:",
  //   customerHistory,
  //   loading,
  // );
  return (
        ...
        <div className="dark:bg-gray-800 relative overflow-hidden bg-white shadow-md sm:rounded-lg">
          ...
          <div className="overflow-x-auto">
            <table className="text-gray-500 dark:text-gray-400 w-full text-left text-sm">
              <thead className="bg-gray-50 bg-gray-50 dark:bg-gray-700 dark:text-gray-400 bg-[#12a19b] text-xs uppercase text-white">
                <tr>
              ...
              <tbody>
                {!loading ? (
                  customerHistory?.map((item: any, index: number) => (
                    <tr
                      className="dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700 border-b"
                      key={index}
                    >
                      ...
                      <td className="text-gray-900 whitespace-nowrap px-4 py-2 font-medium dark:text-white">
                        <div className="flex items-center">
                          {parseFloat((item.selectedTime / 60).toFixed(2))}
                        </div>
                      </td>
                    </tr>
                  ))
