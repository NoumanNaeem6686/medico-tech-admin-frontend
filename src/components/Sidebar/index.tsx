...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-white shadow-lg duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ${
    ...
    >
      ...
      <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
        ...
        <nav className="mt-5 px-4 py-4 lg:mt-9 lg:px-6">
          {/* <!-- Menu Group --> */}
          <div>
            {/* <h3 className="mb-4 ml-4 text-sm font-semibold text-black hover:bg-[#12a19b] py-2">
              MENU
            </h3> */}
            ...
            <ul className=" flex flex-col gap-1.5">
                      ...
                      >
                        <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                          <li>
                            <Link
                              href="/"
                              className={`group relative flex items-center gap-2.5 rounded-md  px-4 py-2 py-2 font-medium text-black duration-300 ease-in-out hover:bg-[#12a19b] hover:text-white ${
                                pathname === "/" &&
              ...
              {/* <li>
                <Link
                  ...
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-black duration-300 ease-in-out hover:bg-[#12a19b] hover:text-white dark:hover:bg-meta-4 ${
                    ...
                    "bg-[#12a19b] dark:bg-meta-4 text-white"
                  }`}
                >
                  <svg
                    className="fill-current"
              ...
              {/* <li>
                <Link
                  href="/profile"
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-black duration-300 ease-in-out hover:bg-[#12a19b] hover:text-white dark:hover:bg-meta-4 ${
                    pathname.includes("profile") && "bg-[#12a19b] dark:bg-meta-4 text-white"
                  }`}
                >
                  <svg
                    className="fill-current"
                        ...
                        <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                          <li>
                            <Link
                              ...
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-black hover:bg-[#12a19b] py-2 duration-300 ease-in-out hover:text-white ${
            ...
            <ul className="mt-2 flex flex-col gap-1.5">
              ...
              {/* <li>
                <Link
                  href="/chart"
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-black duration-300 ease-in-out hover:bg-[#12a19b] hover:text-white dark:hover:bg-meta-4 ${
                    pathname.includes("chart") && "bg-[#12a19b] dark:bg-meta-4 text-white"
                  }`}
                >
                  <svg
                    className="fill-current"
                      ...
                      >
                        <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                          {/* <li>
                            <Link
                              href="/auth/signin"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 py-2 font-medium text-black duration-300 ease-in-out hover:bg-[#12a19b] hover:text-white ${
