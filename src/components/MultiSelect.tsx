...
const languages = [
  ...
  'Arabic', 'Portuguese', 'Hindi', 'Bengali', 'Korean', 'Italian', 'Dutch',
  'Turkish', 'Vietnamese', 'Swedish', 'Polish', 'Danish', 'Finnish', 'Norwegian'
];
//@ts-ignore
          ...
          {selected.map(value => (
            <Chip
              ...
              onDelete={(event) => {
                ...
                const newPersonName = personName.filter(name => name !== value);
